    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <h1 className="text-lg font-semibold text-foreground">Férias</h1>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-left px-4 py-3 text-xs font-medium text-muted">Início</th>
              <th className="text-left px-4 py-3 text-xs font-medium text-muted">Fim</th>
              <th className="text-left px-4 py-3 text-xs font-medium text-muted">Dias</th>
